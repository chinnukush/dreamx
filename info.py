...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002447436146 -1002515386092 -1002082701021 -1001603505179 -1002578416876').split()]  # Channel id for auto indexing (make sure bot is admin)
...
# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1002440757122")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "-1002440757122")# Channels for force sub (make sure bot is admin)

# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://i.ibb.co/dwHTPZ4D/image.jpg')    # QR code image for payments
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://anikush8310:a0dTYntMqgRNf39e@cluster0.szgiyw7.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")  # MongoDB URI for the database
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://anikush8310:hr62FDk6kCMlFpZv@cluster0.wrau1j0.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")  # MongoDB URI for the second database (if MULTIPLE_DB is True)
# ============================
# Movie Notification & Update Settings
# ============================
MOVIE_UPDATE_NOTIFICATION = bool(environ.get('MOVIE_UPDATE_NOTIFICATION', True))  # Notification On (True) / Off (False)
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002283516790'))  # Notification of sent to your channel
...
TUTORIAL = environ.get("TUTORIAL", "https://www.instagram.com/reel/DPdcKpEEdl7/?igsh=MWoyc3lzOXd3bWZweg==")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://www.instagram.com/reel/DPdcKpEEdl7/?igsh=MWoyc3lzOXd3bWZweg==")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://www.instagram.com/reel/DPdcKpEEdl7/?igsh=MWoyc3lzOXd3bWZweg==")   # Third tutorial link for verification
...
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/hari_moviez') # Owner link for the bot
...
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '7253187871').split()]
