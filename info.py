...
# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1003034127772")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "-1003034127772")# Channels for force sub (make sure bot is admin)
...
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/HK_How_To_Open/2")   # Third tutorial link for verification
...
SHORTENER_API3 = environ.get("SHORTENER_API3", "7ec0f6c62f20266998ba5a7ae16a1e1095cad590")  
